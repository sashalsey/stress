...
class ForwardSolve:
    def __init__(self, outputFolder, outputFolder2, beta, penalisationExponent, variableInitialisation, rho0, pnorm, scenario, initial_stressintegral):
        ...
        self.dt2 = 25.0 # timestep for cooling
    ...
    def Solve(self, designVariables):
        ...
        if identicalVariables is False:
            ...
            def distortion_solve(self, T_n1, T_n, E, rho, alpha):
                ...
                fd.solve(a_t == L_t, sol, bcs=[self.mech_bc1])
            ...
            for i in range(n):
                ...
                k = 1000
                if i == 0: self.T_1 = 100.0
                elif i == 1: self.T_1 = 80.0
                else: self.T_1 = 60.0
                ...
                distortion_solve(self, self.T_n, self.T_n1, self.E, self.rho_dep, self.alpha_1)
                ...
                while current_time < self.t_heat:
                    ...
                    distortion_solve(self, self.T_n1, self.T_n, self.E, self.rho_dep, self.alpha_1)
                    ...
                    if i == n - 1: # Forced cooled to ambient
                        temp_tolerance = 0.1  # Temperature difference considered "cooled"
            ...
            plt.subplot(1, 2, 1)
            plt.semilogx(time_steps, max_temps, 'r-', label='Temperature')
